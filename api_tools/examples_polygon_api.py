...
def example_1():
    ...
    credentials = User(api_key="xxxxxxxx")
    show_progress = True # progress bar for each download
    out_folder = "C:/test/"

    from_date = datetime(year=2021, month=6, day=5)
    to_date = datetime(year=2021, month=6, day=7)
    ...
    while from_date < to_date:
        ...
        query = Query(bounding_box, str(from_date), resolution, bands, epsg_out, filetype)
